...
# ════════════════════════════════════════════════════════════════════════════
# ── Commission Invoice routes (GBInc + GBBV) ─────────────────────────────────
# Remove this block and ci_routes import to drop the feature.
# ════════════════════════════════════════════════════════════════════════════

register_all_commission_invoice_routes(
    app,
    templates=templates,
    ctx=ctx,
    download_response=_download_response,
    authorized_signature_file_uri=authorized_signature_file_uri,
)
