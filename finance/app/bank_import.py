...
BANK_RULES: list[BankRule] = [
    ...
    _r(21, "NJ web tax", r"NJWEB|NJ WEB PMT", "debit",
       "Taxes", "NJ Division of Taxation", "high", precheck=True),
    ...
    _r(14, "Bank service charge", r"Service Charges", "debit",
       "Bank Charges", "Chemung Canal Trust", "high", precheck=True),
    _r(22, "Mastercard FX / CBA fee", r"MASTERCARD CBA FEE", "debit",
       "Bank Charges", "Mastercard", "high", precheck=True),
    _r(23, "POS return (credit)", r"POS RETURN", "credit",
       "Other Income", "", "medium", precheck=True),
    _r(24, "United Airlines", r"PURCHASE-SIG UNITED\b", "debit",
       "Airfare", "United Airlines", "high", precheck=True),
    _r(25, "World Bio Market", r"WORLD BIO MARKET", "debit",
       "Conference Expense", "World Bio Market", "high", precheck=True),
